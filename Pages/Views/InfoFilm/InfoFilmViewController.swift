...
class InfoFilmViewController: UIViewController {
  ...
  var similar = [Movies]()
  var isState = true
  var viewModels = InfoMovieViewModels()
  ...
  @IBAction func clickBotButton(_ sender: Any) {
  ...
  func reloadViewController(_ movie : Movies) {
    dataF = movie
    viewWillAppear(true)
    viewDidLoad()
    scrollToTop()
