...
class FireBaseManager {
  ...
  //Mark: register
  func register(_ email: String, _ password: String,_ name : String ,completion: @escaping ((_ success: Bool) -> Void)) {
  ...
  func firebaseSignInWithLink(credential: AuthCredential , completion: @escaping ((_ success: Bool) -> Void) ) {
